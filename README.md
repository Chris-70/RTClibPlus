...
- **Century support**: The DS3231 chip supports century mode, this is now supported in the [RTC_DS3231](./src/RTC_DS3231.cpp) class. The DS1307 does not support century mode so it is not implemented in that class. The `DateTime` class now supports the century mode so dates from 2001-01-01 to 2136-02-07 can be used. The days calculations account for the year 2100 not being a leap year.
...
## DateTime::toString()
   ...
   |-------------|------------------------------------------|-------------------|----------|
   | `YYYY`      | the year as a 4-digit number             | (2000--2136)      | Modified |
